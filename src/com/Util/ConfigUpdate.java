...
public class ConfigUpdate
{
  public static void update() {
    ...
    if (Main.JavaPlugin.getConfig().isConfigurationSection("Version")) {
      Main.JavaPlugin.getConfig().set("Version", 2.0296);
    ...
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.027D) {
        ...
        if(Main.JavaPlugin.getConfig().isConfigurationSection("CheckUpdate") == false) {
        ...
        if(Main.JavaPlugin.getConfig().isConfigurationSection("DisablePortalCreate") == false) {
