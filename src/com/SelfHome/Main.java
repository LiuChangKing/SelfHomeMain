  ...
  public void onDisable() {
    ...
    for (World temp : Bukkit.getWorlds()) {
      if (Variable.hololist.containsKey(Variable.prefix_p + temp.getName())) {
        for (Hologram temp2 : Variable.hololist.get(Variable.prefix_p + temp.getName())) {
          temp2.delete();
        }
      }
    }
...
Bukkit.getConsoleSender().sendMessage(Variable.Lang_YML.getString("AutoSaveSuccess"));
  ...
  public void onEnable() {
    JavaPlugin = this;
    	    ...
    	    int pluginId = 19436;
    	    Metrics ms = new Metrics(Main.JavaPlugin,pluginId);
    ...
    if (!JavaPlugin.getConfig().getBoolean("DisableFunctionButTeleport")) {
      ...
      if (JavaPlugin.getServer().getPluginManager().getPlugin("Multiverse-Core") != null && Main.JavaPlugin.getConfig().getBoolean("MultiverseCoreCompability")) {
      ...
      if (JavaPlugin.getServer().getPluginManager().getPlugin("FastAsyncWorldEdit") != null && Main.JavaPlugin.getConfig().getBoolean("FaweSwitch")) {
    ...
    if(Main.JavaPlugin.getConfig().getBoolean("CheckUpdate")) {
    	com.Util.CheckUpdate.checkUpdate();
    }
  ...
  public static void init() {
    ...
    Variable.prefix_p = Main.JavaPlugin.getConfig().getString("WorldPrefix");
    ...
    Variable.custom_playerdata_location = String.valueOf(Variable.Final) + Variable.ab[Variable.ab.length - 1] + 
      Variable.file_loc_prefix + "plugins" + Variable.file_loc_prefix + "SelfHomeMain" + 
      Variable.file_loc_prefix + "playerdata";

    
    Variable.custom_autobackup_location = String.valueOf(Variable.Final) + Variable.ab[Variable.ab.length - 1] + 
      Variable.file_loc_prefix + "plugins" + Variable.file_loc_prefix + "SelfHomeMain" + 
    ...
    Variable.worldFinal = String.valueOf(Tempf0) + Variable.file_loc_prefix + "plugins" + Variable.file_loc_prefix + "SelfHomeMain" + 
      Variable.file_loc_prefix;
    Variable.Log_All = String.valueOf(Tempf0) + Variable.file_loc_prefix + "plugins" + Variable.file_loc_prefix + "SelfHomeMain" + 
      Variable.file_loc_prefix;
    
    Variable.single_server_gen = String.valueOf(Variable.Final) + Variable.file_loc_prefix + Variable.ab[Variable.ab.length - 1] + 
      Variable.file_loc_prefix;
        ...
        if (somedata[0].equalsIgnoreCase("waitDelayToHome")) {
          ...
          if (Variable.world_prefix.equalsIgnoreCase("")) {
            if (Bukkit.getVersion().toString().toUpperCase().contains("ARCLIGHT") || Bukkit.getVersion().toString().contains("1.20.1")) {
              ...
              new_f = new File(
                  String.valueOf(Variable.single_server_gen) + "world" + Variable.file_loc_prefix + wt.home_name);
            }
