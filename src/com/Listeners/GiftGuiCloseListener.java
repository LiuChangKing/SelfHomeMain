...
public class GiftGuiCloseListener
  implements Listener
{
    ...
    (new BukkitRunnable()
      {
        public void run() {
          ...
          List<String> gifts = new ArrayList<>(); int b;
          int j;
          ItemStack[] arrayOfItemStack;
          for (j = (arrayOfItemStack = event.getInventory().getContents()).length, b = 0; b < j; ) { ItemStack i = arrayOfItemStack[b];
            if (i != null)
            {
